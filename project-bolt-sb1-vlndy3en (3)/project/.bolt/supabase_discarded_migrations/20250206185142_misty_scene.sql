/*
  ...
  1. Changes
    - Drop and recreate deepseek_cache table with proper structure
    - Add composite indexes for better performance
    - Add improved cache management functions
    - Add cache analytics functions
